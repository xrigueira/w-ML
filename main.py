...
class Model():
    ...
    The difference with the program in the clean.py file is that this one works on the whole dataset.
    """
...
if __name__ == '__main__':
    ...
    model = Model(model_name='svm', station=905, window_size=32, stride=1, threshold=0.65, search=False)
